...
$DANCES_BESTMEN_DANCE_DESCRIPTION = 
 "Направете поздрав за вашите приятели на техния празник. Покажете им колко ги обичате и цените с вашите движения.
Добавете специални спомени към специалното събитие.";
...
$QANDA_2A_QUESTION = "Какъв стил ще бъде моят танц?";

$QANDA_2A_ANSWER =
 "С една дума - по поръчка. Уникален. От многото стилове танци, ние умело можем да преплетем латиноамерикански 
танци(румба, ча-ча, джайв, самба, пасо добле) или стандартни(английски и виенски валс, фокстрот, куикстеп, танго) 
с елементи от класически и джаз балет, диско, съвременен танц и с вашия собствен стил.";  
