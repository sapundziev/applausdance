...
$INDEX_APPLAUS_DANCE = "ApplauS Dance е мястото, където с помощта на опитни хореографи, хората се докосват до магията на танца,  
...
вашето облекло в деня на събитието, комбинирани с напрежението и желанието всичко да е перфектно - 
всичко се упражнява в условия, максимално близки до тези на сватбата. 
Ние разбираме, че първият сватбен танц за повечето хора е уникално в живота преживяване и правим подобаваща хореография. 
...
$DANCES_BESTMEN_DANCE_DESCRIPTION = 
 "Поздравете и изненадайте приятелите си на празничното събитие. Покажете им любовта си чрез изтънчени движения.
Създайте специални спомени на специалния повод.";
...
Независимо дали търсите герои за историята, сюжета или реквизита за нея, викнете вашето „Иии иха“ 
...
$GALLERY_TITLE_PICTURES = "Снимки";
$GALLERY_TITLE_VIDEOS = "Видео";
...
$QANDA_4_ANSWER =
 "В момента разполагаме със зала в Княжево и Мусагеница, София. Ако вие можете да предоставите място, подходящо за танци, ще го използваме.
...
$CONTACT_ADDRESS = "Мусагеница";

$CONTACT_CITY = "София";

$CONTACT_ADDRESS_1 = "бул. Цар Борис III, 375";

$CONTACT_CITY_1 = "София, 1618";
