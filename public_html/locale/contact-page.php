...
<div class="content-wrapper">
    ...
    <div class ="text-wrapper">
        <div class="main-content clearfix">
            <h1 class="page-title">gettext("CONTACT_TITLE")</h1>
            <div id="contact-form">
